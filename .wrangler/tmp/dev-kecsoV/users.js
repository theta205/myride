(() => {
  ...
  // .wrangler/tmp/bundle-Gzf0ZL/checked-fetch.js
...
`
  ...
  // .wrangler/tmp/bundle-Gzf0ZL/middleware-insertion-facade.js
  ...
  async function onRequestGet(context) {
    ...
    try {
      const response = await axios_default.get("https://api.clerk.com/v1/users", {
        headers: {
